...
public class NumberPicker extends LinearLayout {
	...
	public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
		...
		// Not picked up by parent since LinearLayout 3 param constructor isn't
		// public.. damn them
	...
	private void setSelectorWheelState(int selectorWheelState) {
		...
		if (mFlingable
			...
			String text = getContext().getString(
					R.string.np_number_picker_increment_scroll_action);
	...
	private void updateInputTextView() {
		...
		if (mFlingable
				&& ((AccessibilityManager) getContext().getSystemService(
						Context.ACCESSIBILITY_SERVICE)).isEnabled()) {
			String text = getContext().getString(
					R.string.np_number_picker_increment_scroll_mode,
					mInputText.getText());
			mInputText.setContentDescription(text);
		}
	}
